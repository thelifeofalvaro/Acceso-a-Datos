...
public class DemoRelaciones {
    ...
    private static void mostrarMenu() {
        System.out.println("=========================================");
        System.out.println("           LAMPREAS VIOLETA              ");
        System.out.println("=========================================");
    ...
    private static void listarPedidos() throws SQLException {
        ...
        for (Pedido p : list) {
            // Cargar líneas, para que el total salga sumado
            List<DetallePedido> lineas = detallePedidoDAO.findByPedidoId(p.getId());

            //Asignar lineas  al pedido
            p.setLineas(lineas);

            //Imprimir pedido (cabecera)
     ...
     *  6) pedido
     *  7) detalle_pedido
     *  NOTA: Cambiado el orden original para evitar errores por FKs o tablas dependientes
     *
     * IMPORTANTE:
    ...
    private static void importarJson() throws IOException, SQLException {
        ...
        // 1) Clientes (Tabla independiente)
    ...
    //Método general para vaciar de contenido todas las tablas de la BBDD
